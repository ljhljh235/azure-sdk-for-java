...
public interface LargePersonGroups {
     ...
     *   Create](/docs/services/563879b61984550e40cbbe8d/operations/599adcba3a7b9412a4d53f40) to add person into the
     *   group, and call [LargePersonGroup -
     *   Train](/docs/services/563879b61984550e40cbbe8d/operations/599ae2d16ac60f11b48b5aa4) to get this group ready
     ...
     *   Create](/docs/services/563879b61984550e40cbbe8d/operations/599acdee6ac60f11b48b5a9d). All those large person
     ...
     */
    Observable<ServiceResponse<Void>> createWithServiceResponseAsync(String largePersonGroupId, CreateLargePersonGroupsOptionalParameter createOptionalParameter);
     ...
     *   List](/docs/services/563879b61984550e40cbbe8d/operations/599adda06ac60f11b48b5aa1) instead to retrieve
     ...
     * @return the observable to the LargePersonGroup object
     */
    Observable<ServiceResponse<LargePersonGroup>> getWithServiceResponseAsync(String largePersonGroupId, GetLargePersonGroupsOptionalParameter getOptionalParameter);
     ...
     * @return the {@link ServiceResponse} object if successful.
     */
    Observable<ServiceResponse<Void>> updateWithServiceResponseAsync(String largePersonGroupId, UpdateLargePersonGroupsOptionalParameter updateOptionalParameter);
     ...
     * @return the observable to the List&lt;LargePersonGroup&gt; object
     */
    Observable<ServiceResponse<List<LargePersonGroup>>> listWithServiceResponseAsync(ListLargePersonGroupsOptionalParameter listOptionalParameter);
