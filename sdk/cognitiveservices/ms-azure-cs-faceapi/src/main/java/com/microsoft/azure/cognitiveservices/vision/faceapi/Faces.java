...
public interface Faces {
     ...
     *   Detect](/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395236), which will expire 24
     ...
     * @return the observable to the List&lt;SimilarFace&gt; object
     */
    Observable<ServiceResponse<List<SimilarFace>>> findSimilarWithServiceResponseAsync(UUID faceId, FindSimilarOptionalParameter findSimilarOptionalParameter);
     ...
     * Divide candidate faces into groups based on face similarity.&lt;br /&gt;
      ...
      *  Verify](/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f3039523a) when you only
      *  have 2 candidate faces.
     ...
     *   * Try [Face - Find Similar](/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395237)
     ...
     * @return the observable to the List&lt;IdentifyResult&gt; object
     */
    Observable<ServiceResponse<List<IdentifyResult>>> identifyWithServiceResponseAsync(List<UUID> faceIds, IdentifyOptionalParameter identifyOptionalParameter);
     ...
     *   Similar](/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395237). The stored face
     ...
     *   Identify](/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395239), [Face -
     *   Verify](/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f3039523a), and [Face - Find
     *   Similar](/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395237) ('returnFaceId' is
     ...
     *   Detect](/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395236). Recommend for near
     ...
     *   recognition model. More details, please refer to [How to specify a recognition
     model](http*   s://docs.microsoft.com/en-us/azure/cognitive-services/face/face-api-how-to-topics/specify-recognition-model)
     *   | Model | Recommended use-case(s) |
     *   | ---------- | -------- |
     *   | 'recognition_01': | The default recognition model for [Face -
     *   Detect](/docs/services/563879b61984550e40cbbe8d/operations/563879b61984550f30395236). All those faceIds
     ...
     * @return the observable to the List&lt;DetectedFace&gt; object
     */
    Observable<ServiceResponse<List<DetectedFace>>> detectWithUrlWithServiceResponseAsync(String url, DetectWithUrlOptionalParameter detectWithUrlOptionalParameter);
     ...
     * @return the observable to the VerifyResult object
     */
    Observable<ServiceResponse<VerifyResult>> verifyFaceToPersonWithServiceResponseAsync(UUID faceId, UUID personId, VerifyFaceToPersonOptionalParameter verifyFaceToPersonOptionalParameter);
     ...
     * @return the observable to the List&lt;DetectedFace&gt; object
     */
    Observable<ServiceResponse<List<DetectedFace>>> detectWithStreamWithServiceResponseAsync(byte[] image, DetectWithStreamOptionalParameter detectWithStreamOptionalParameter);
