...
import com.azure.cognitiveservices.face.models.ApplySnapshotRequest;
import com.azure.cognitiveservices.face.models.OperationStatus;
import com.azure.cognitiveservices.face.models.Snapshot;
import com.azure.cognitiveservices.face.models.SnapshotApplyMode;
import com.azure.cognitiveservices.face.models.SnapshotObjectType;
import com.azure.cognitiveservices.face.models.SnapshotsApplyResponse;
import com.azure.cognitiveservices.face.models.SnapshotsTakeResponse;
import com.azure.cognitiveservices.face.models.TakeSnapshotRequest;
import com.azure.cognitiveservices.face.models.UpdateSnapshotRequest;
...
public final class SnapshotsImpl implements Snapshots {
    ...
    /**
     * The interface defining all the services for FaceClientSnapshots to be
    ...
    public Mono<SnapshotsTakeResponse> takeWithRestResponseAsync(SnapshotObjectType type, String objectId, List<UUID> applyScope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> takeAsync(SnapshotObjectType type, String objectId, List<UUID> applyScope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SnapshotsTakeResponse> takeWithRestResponseAsync(SnapshotObjectType type, String objectId, List<UUID> applyScope, String userData) {
        TakeSnapshotRequest body = new TakeSnapshotRequest();
        body.setType(type);
        body.setObjectId(objectId);
        body.setApplyScope(applyScope);
    ...
    public Mono<SimpleResponse<List<Snapshot>>> listWithRestResponseAsync() {
        ...
        String applyScopeConverted = null;
    ...
    public Mono<List<Snapshot>> listAsync() {
        return listWithRestResponseAsync()
            .flatMap((SimpleResponse<List<Snapshot>> res) -> {
    ...
    public Mono<SimpleResponse<List<Snapshot>>> listWithRestResponseAsync(SnapshotObjectType type, List<UUID> applyScope) {
        String applyScopeConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(applyScope, CollectionFormat.CSV);
        return service.list(this.client.getEndpoint(), type, applyScopeConverted);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<Snapshot>> getWithRestResponseAsync(UUID snapshotId) {
        return service.get(snapshotId, this.client.getEndpoint());
    }
    ...
    public Mono<Snapshot> getAsync(UUID snapshotId) {
        return getWithRestResponseAsync(snapshotId)
            .flatMap((SimpleResponse<Snapshot> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
                    return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VoidResponse> updateWithRestResponseAsync(UUID snapshotId) {
        UpdateSnapshotRequest body = new UpdateSnapshotRequest();
        body.setApplyScope(null);
        body.setUserData(null);
        return service.update(snapshotId, this.client.getEndpoint(), body);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> updateAsync(UUID snapshotId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VoidResponse> updateWithRestResponseAsync(UUID snapshotId, List<UUID> applyScope, String userData) {
        UpdateSnapshotRequest body = new UpdateSnapshotRequest();
        body.setApplyScope(applyScope);
        body.setUserData(userData);
        return service.update(snapshotId, this.client.getEndpoint(), body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VoidResponse> deleteWithRestResponseAsync(UUID snapshotId) {
        return service.delete(snapshotId, this.client.getEndpoint());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SnapshotsApplyResponse> applyWithRestResponseAsync(UUID snapshotId, String objectId) {
        ApplySnapshotRequest body = new ApplySnapshotRequest();
        body.setObjectId(objectId);
        body.setMode(null);
        return service.apply(snapshotId, this.client.getEndpoint(), body);
    }
    ...
    public Mono<Void> applyAsync(UUID snapshotId, String objectId) {
        return applyWithRestResponseAsync(snapshotId, objectId)
            .flatMap((SnapshotsApplyResponse res) -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SnapshotsApplyResponse> applyWithRestResponseAsync(UUID snapshotId, String objectId, SnapshotApplyMode mode) {
        ApplySnapshotRequest body = new ApplySnapshotRequest();
        body.setObjectId(objectId);
        body.setMode(mode);
        return service.apply(snapshotId, this.client.getEndpoint(), body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> applyAsync(UUID snapshotId, String objectId, SnapshotApplyMode mode) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<OperationStatus>> getOperationStatusWithRestResponseAsync(UUID operationId) {
        return service.getOperationStatus(operationId, this.client.getEndpoint());
    }
    ...
    public Mono<OperationStatus> getOperationStatusAsync(UUID operationId) {
        return getOperationStatusWithRestResponseAsync(operationId)
            .flatMap((SimpleResponse<OperationStatus> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
                    return Mono.empty();
