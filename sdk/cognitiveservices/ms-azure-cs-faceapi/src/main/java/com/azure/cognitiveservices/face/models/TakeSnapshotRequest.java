...
public final class TakeSnapshotRequest {
    ...
    /**
     * Get the type property: User specified type for the source object to take
    ...
    /**
     * Set the type property: User specified type for the source object to take
     * snapshot from. Currently FaceList, PersonGroup, LargeFaceList and
     * LargePersonGroup are supported. Possible values include: 'FaceList',
     * 'LargeFaceList', 'LargePersonGroup', 'PersonGroup'.
     *
    ...
    /**
     * Get the objectId property: User specified source object id to take
     * snapshot from.
     *
    ...
    /**
     * Set the objectId property: User specified source object id to take
     * snapshot from.
     *
    ...
    /**
     * Get the applyScope property: User specified array of target Face
    ...
    /**
     * Set the applyScope property: User specified array of target Face
     * subscription ids for the snapshot. For each snapshot, only subscriptions
     * included in the applyScope of Snapshot - Take can apply it.
     *
