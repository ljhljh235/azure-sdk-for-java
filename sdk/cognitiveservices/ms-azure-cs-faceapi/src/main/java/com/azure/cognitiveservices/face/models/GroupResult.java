...
public final class GroupResult {
    ...
    /**
     * Get the groups property: A partition of the original faces based on face
    ...
    /**
     * Set the groups property: A partition of the original faces based on face
     * similarity. Groups are ranked by number of faces.
     *
    ...
    /**
     * Get the messyGroup property: Face ids array of faces that cannot find
    ...
    /**
     * Set the messyGroup property: Face ids array of faces that cannot find
     * any similar faces from original faces.
     *
