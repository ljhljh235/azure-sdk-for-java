...
public final class IdentifyRequest {
    ...
    /**
     * Get the faceIds property: Array of query faces faceIds, created by the
    ...
    /**
     * Set the faceIds property: Array of query faces faceIds, created by the
     * Face - Detect. Each of the faces are identified independently. The valid
     * number of faceIds is between [1, 10].
     *
    ...
    /**
     * Get the maxNumOfCandidatesReturned property: The range of
    ...
    /**
     * Set the maxNumOfCandidatesReturned property: The range of
     * maxNumOfCandidatesReturned is between 1 and 5 (default is 1).
     *
    ...
    /**
     * Get the confidenceThreshold property: Confidence threshold of
    ...
    /**
     * Set the confidenceThreshold property: Confidence threshold of
     * identification, used to judge whether one face belong to one person. The
     * range of confidenceThreshold is [0, 1] (default specified by algorithm).
     *
     ...
     * @return the IdentifyRequest object itself.
     */
    public IdentifyRequest setConfidenceThreshold(Double confidenceThreshold) {
