...
public final class VerifyFaceToPersonRequest {
    ...
    /**
     * Get the personGroupId property: Using existing personGroupId and
     * personId for fast loading a specified person. personGroupId is created
     * in PersonGroup - Create. Parameter personGroupId and largePersonGroupId
    ...
    /**
     * Set the personGroupId property: Using existing personGroupId and
     * personId for fast loading a specified person. personGroupId is created
     * in PersonGroup - Create. Parameter personGroupId and largePersonGroupId
     * should not be provided at the same time.
     *
    ...
    /**
     * Get the largePersonGroupId property: Using existing largePersonGroupId
    ...
    /**
     * Set the largePersonGroupId property: Using existing largePersonGroupId
     * and personId for fast loading a specified person. largePersonGroupId is
     * created in LargePersonGroup - Create. Parameter personGroupId and
     * largePersonGroupId should not be provided at the same time.
     *
    ...
    /**
     * Get the personId property: Specify a certain person in a person group or
    ...
    /**
     * Set the personId property: Specify a certain person in a person group or
     * a large person group. personId is created in PersonGroup Person - Create
     * or LargePersonGroup Person - Create.
     *
