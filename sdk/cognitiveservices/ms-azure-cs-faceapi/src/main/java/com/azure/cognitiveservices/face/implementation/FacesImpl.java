...
import com.azure.cognitiveservices.face.models.DetectedFace;
import com.azure.cognitiveservices.face.models.DetectionModel;
import com.azure.cognitiveservices.face.models.FaceAttributeType;
import com.azure.cognitiveservices.face.models.FindSimilarMatchMode;
import com.azure.cognitiveservices.face.models.FindSimilarRequest;
import com.azure.cognitiveservices.face.models.GroupRequest;
import com.azure.cognitiveservices.face.models.GroupResult;
import com.azure.cognitiveservices.face.models.IdentifyRequest;
import com.azure.cognitiveservices.face.models.IdentifyResult;
import com.azure.cognitiveservices.face.models.ImageUrl;
import com.azure.cognitiveservices.face.models.RecognitionModel;
import com.azure.cognitiveservices.face.models.SimilarFace;
import com.azure.cognitiveservices.face.models.VerifyFaceToFaceRequest;
import com.azure.cognitiveservices.face.models.VerifyFaceToPersonRequest;
import com.azure.cognitiveservices.face.models.VerifyResult;
...
public final class FacesImpl implements Faces {
    ...
    /**
     * The interface defining all the services for FaceClientFaces to be used
    ...
    private interface FacesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(APIErrorException.class)
        Mono<SimpleResponse<List<DetectedFace>>> detectWithUrl(@HostParam("Endpoint") String endpoint, @QueryParam("returnFaceId") Boolean returnFaceId, @QueryParam("returnFaceLandmarks") Boolean returnFaceLandmarks, @QueryParam("returnFaceAttributes") String returnFaceAttributes, @QueryParam("recognitionModel") RecognitionModel recognitionModel1, @QueryParam("returnRecognitionModel") Boolean returnRecognitionModel, @QueryParam("detectionModel") DetectionModel detectionModel1, @BodyParam("application/json; charset=utf-8") ImageUrl imageUrl);
    ...
    public Mono<SimpleResponse<List<SimilarFace>>> findSimilarWithRestResponseAsync(UUID faceId) {
        FindSimilarRequest body = new FindSimilarRequest();
        body.setFaceId(faceId);
        body.setFaceListId(null);
        body.setLargeFaceListId(null);
        body.setFaceIds(null);
        body.setMaxNumOfCandidatesReturned(null);
        body.setMode(null);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<SimilarFace>> findSimilarAsync(UUID faceId) {
        return findSimilarWithRestResponseAsync(faceId)
            .flatMap((SimpleResponse<List<SimilarFace>> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<List<SimilarFace>>> findSimilarWithRestResponseAsync(UUID faceId, String faceListId, String largeFaceListId, List<UUID> faceIds, Integer maxNumOfCandidatesReturned, FindSimilarMatchMode mode) {
        FindSimilarRequest body = new FindSimilarRequest();
        body.setFaceId(faceId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<SimilarFace>> findSimilarAsync(UUID faceId, String faceListId, String largeFaceListId, List<UUID> faceIds, Integer maxNumOfCandidatesReturned, FindSimilarMatchMode mode) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<GroupResult>> groupWithRestResponseAsync(List<UUID> faceIds) {
    ...
    public Mono<GroupResult> groupAsync(List<UUID> faceIds) {
        return groupWithRestResponseAsync(faceIds)
            .flatMap((SimpleResponse<GroupResult> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
                    return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<List<IdentifyResult>>> identifyWithRestResponseAsync(List<UUID> faceIds) {
        IdentifyRequest body = new IdentifyRequest();
        body.setFaceIds(faceIds);
        body.setPersonGroupId(null);
        body.setLargePersonGroupId(null);
        body.setMaxNumOfCandidatesReturned(null);
        body.setConfidenceThreshold(null);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<IdentifyResult>> identifyAsync(List<UUID> faceIds) {
        return identifyWithRestResponseAsync(faceIds)
            .flatMap((SimpleResponse<List<IdentifyResult>> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
                    return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<List<IdentifyResult>>> identifyWithRestResponseAsync(List<UUID> faceIds, String personGroupId, String largePersonGroupId, Integer maxNumOfCandidatesReturned, Double confidenceThreshold) {
        IdentifyRequest body = new IdentifyRequest();
        body.setFaceIds(faceIds);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<IdentifyResult>> identifyAsync(List<UUID> faceIds, String personGroupId, String largePersonGroupId, Integer maxNumOfCandidatesReturned, Double confidenceThreshold) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<VerifyResult>> verifyFaceToFaceWithRestResponseAsync(UUID faceId1, UUID faceId2) {
    ...
    public Mono<VerifyResult> verifyFaceToFaceAsync(UUID faceId1, UUID faceId2) {
        return verifyFaceToFaceWithRestResponseAsync(faceId1, faceId2)
            .flatMap((SimpleResponse<VerifyResult> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
                    return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<List<DetectedFace>>> detectWithUrlWithRestResponseAsync(String url) {
        ...
        imageUrl.setUrl(url);
        String returnFaceAttributesConverted = null;
        return service.detectWithUrl(this.client.getEndpoint(), returnFaceId, returnFaceLandmarks, returnFaceAttributesConverted, recognitionModel, returnRecognitionModel, detectionModel, imageUrl);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<DetectedFace>> detectWithUrlAsync(String url) {
        return detectWithUrlWithRestResponseAsync(url)
            .flatMap((SimpleResponse<List<DetectedFace>> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
                    return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<List<DetectedFace>>> detectWithUrlWithRestResponseAsync(String url, Boolean returnFaceId, Boolean returnFaceLandmarks, List<FaceAttributeType> returnFaceAttributes, RecognitionModel recognitionModel, Boolean returnRecognitionModel, DetectionModel detectionModel) {
        ImageUrl imageUrl = new ImageUrl();
        imageUrl.setUrl(url);
        String returnFaceAttributesConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(returnFaceAttributes, CollectionFormat.CSV);
        return service.detectWithUrl(this.client.getEndpoint(), returnFaceId, returnFaceLandmarks, returnFaceAttributesConverted, recognitionModel, returnRecognitionModel, detectionModel, imageUrl);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<DetectedFace>> detectWithUrlAsync(String url, Boolean returnFaceId, Boolean returnFaceLandmarks, List<FaceAttributeType> returnFaceAttributes, RecognitionModel recognitionModel, Boolean returnRecognitionModel, DetectionModel detectionModel) {
        return detectWithUrlWithRestResponseAsync(url, returnFaceId, returnFaceLandmarks, returnFaceAttributes, recognitionModel, returnRecognitionModel, detectionModel)
            .flatMap((SimpleResponse<List<DetectedFace>> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<VerifyResult>> verifyFaceToPersonWithRestResponseAsync(UUID faceId, UUID personId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VerifyResult> verifyFaceToPersonAsync(UUID faceId, UUID personId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<VerifyResult>> verifyFaceToPersonWithRestResponseAsync(UUID faceId, UUID personId, String personGroupId, String largePersonGroupId) {
        VerifyFaceToPersonRequest body = new VerifyFaceToPersonRequest();
        body.setFaceId(faceId);
        body.setPersonGroupId(personGroupId);
        body.setLargePersonGroupId(largePersonGroupId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VerifyResult> verifyFaceToPersonAsync(UUID faceId, UUID personId, String personGroupId, String largePersonGroupId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<List<DetectedFace>>> detectWithStreamWithRestResponseAsync(long contentLength, Flux<ByteBuffer> image) {
        final Boolean returnFaceId = true;
        final Boolean returnFaceLandmarks = false;
        final RecognitionModel recognitionModel = RecognitionModel.RECOGNITION_01;
        final Boolean returnRecognitionModel = false;
        final DetectionModel detectionModel = DetectionModel.DETECTION_01;
        String returnFaceAttributesConverted = null;
        return service.detectWithStream(this.client.getEndpoint(), returnFaceId, returnFaceLandmarks, returnFaceAttributesConverted, contentLength, image, recognitionModel, returnRecognitionModel, detectionModel);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<DetectedFace>> detectWithStreamAsync(long contentLength, Flux<ByteBuffer> image) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<List<DetectedFace>>> detectWithStreamWithRestResponseAsync(long contentLength, Flux<ByteBuffer> image, Boolean returnFaceId, Boolean returnFaceLandmarks, List<FaceAttributeType> returnFaceAttributes, RecognitionModel recognitionModel, Boolean returnRecognitionModel, DetectionModel detectionModel) {
        String returnFaceAttributesConverted = JacksonAdapter.createDefaultSerializerAdapter().serializeList(returnFaceAttributes, CollectionFormat.CSV);
        return service.detectWithStream(this.client.getEndpoint(), returnFaceId, returnFaceLandmarks, returnFaceAttributesConverted, contentLength, image, recognitionModel, returnRecognitionModel, detectionModel);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<DetectedFace>> detectWithStreamAsync(long contentLength, Flux<ByteBuffer> image, Boolean returnFaceId, Boolean returnFaceLandmarks, List<FaceAttributeType> returnFaceAttributes, RecognitionModel recognitionModel, Boolean returnRecognitionModel, DetectionModel detectionModel) {
        return detectWithStreamWithRestResponseAsync(contentLength, image, returnFaceId, returnFaceLandmarks, returnFaceAttributes, recognitionModel, returnRecognitionModel, detectionModel)
            .flatMap((SimpleResponse<List<DetectedFace>> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
