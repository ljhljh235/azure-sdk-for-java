...
import com.azure.cognitiveservices.face.models.LargePersonGroup;
...
public final class LargePersonGroupsImpl implements LargePersonGroups {
    ...
    /**
     * The interface defining all the services for FaceClientLargePersonGroups
     * to be used by the proxy service to perform REST calls.
     */
    @Host("{Endpoint}/face/v1.0")
    @ServiceInterface(name = "FaceClientLargePersonGroups")
    ...
    public Mono<VoidResponse> createWithRestResponseAsync(String largePersonGroupId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> createAsync(String largePersonGroupId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VoidResponse> createWithRestResponseAsync(String largePersonGroupId, String name, String userData, RecognitionModel recognitionModel) {
        MetaDataContract body = new MetaDataContract();
        body.setName(name);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> createAsync(String largePersonGroupId, String name, String userData, RecognitionModel recognitionModel) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VoidResponse> deleteWithRestResponseAsync(String largePersonGroupId) {
        return service.delete(largePersonGroupId, this.client.getEndpoint());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<LargePersonGroup>> getWithRestResponseAsync(String largePersonGroupId) {
        final Boolean returnRecognitionModel = false;
        return service.get(largePersonGroupId, this.client.getEndpoint(), returnRecognitionModel);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<LargePersonGroup> getAsync(String largePersonGroupId) {
        return getWithRestResponseAsync(largePersonGroupId)
            .flatMap((SimpleResponse<LargePersonGroup> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<LargePersonGroup>> getWithRestResponseAsync(String largePersonGroupId, Boolean returnRecognitionModel) {
        return service.get(largePersonGroupId, this.client.getEndpoint(), returnRecognitionModel);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VoidResponse> updateWithRestResponseAsync(String largePersonGroupId) {
        NameAndUserDataContract body = new NameAndUserDataContract();
        body.setName(null);
        body.setUserData(null);
        return service.update(largePersonGroupId, this.client.getEndpoint(), body);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> updateAsync(String largePersonGroupId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VoidResponse> updateWithRestResponseAsync(String largePersonGroupId, String name, String userData) {
        NameAndUserDataContract body = new NameAndUserDataContract();
        body.setName(name);
        body.setUserData(userData);
        return service.update(largePersonGroupId, this.client.getEndpoint(), body);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<TrainingStatus>> getTrainingStatusWithRestResponseAsync(String largePersonGroupId) {
        return service.getTrainingStatus(largePersonGroupId, this.client.getEndpoint());
    }
    ...
    public Mono<List<LargePersonGroup>> listAsync() {
        return listWithRestResponseAsync()
            .flatMap((SimpleResponse<List<LargePersonGroup>> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
                    return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VoidResponse> trainWithRestResponseAsync(String largePersonGroupId) {
        return service.train(largePersonGroupId, this.client.getEndpoint());
    }
