...
public final class OperationStatus {
    ...
    /**
     * Get the status property: Operation status: notstarted, running,
     ...
     * while applying the snapshot before completion, see the field "message"
     * to check the failure reason. Possible values include: 'notstarted',
    ...
    /**
     * Set the status property: Operation status: notstarted, running,
     * succeeded, failed. If the operation is requested and waiting to perform,
     * the status is notstarted. If the operation is ongoing in backend, the
     * status is running. Status succeeded means the operation is completed
     * successfully, specifically for snapshot taking operation, it illustrates
    ...
    /**
     * Get the lastActionTime property: A combined UTC date and time string
     * that describes the last time the operation (take or apply a snapshot) is
     * actively migrating data. The lastActionTime will keep increasing until
     * the operation finishes. E.g. 2018-12-25T11:51:27.8705696Z.
     *
    ...
    /**
     * Set the lastActionTime property: A combined UTC date and time string
     * that describes the last time the operation (take or apply a snapshot) is
     * actively migrating data. The lastActionTime will keep increasing until
     * the operation finishes. E.g. 2018-12-25T11:51:27.8705696Z.
     *
    ...
    /**
     * Get the resourceLocation property: When the operation succeeds
    ...
    /**
     * Set the resourceLocation property: When the operation succeeds
     * successfully, for snapshot taking operation the snapshot id will be
     * included in this field, and for snapshot applying operation, the path to
     * get the target object will be returned in this field.
     *
    ...
    /**
     * Get the message property: Show failure message when operation fails
    ...
    /**
     * Set the message property: Show failure message when operation fails
     * (omitted when operation succeeds).
     *
