...
public interface Faces {
    ...
    Mono<SimpleResponse<List<SimilarFace>>> findSimilarWithRestResponseAsync(UUID faceId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<SimilarFace>> findSimilarAsync(UUID faceId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SimpleResponse<List<SimilarFace>>> findSimilarWithRestResponseAsync(UUID faceId, String faceListId, String largeFaceListId, List<UUID> faceIds, Integer maxNumOfCandidatesReturned, FindSimilarMatchMode mode);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<SimilarFace>> findSimilarAsync(UUID faceId, String faceListId, String largeFaceListId, List<UUID> faceIds, Integer maxNumOfCandidatesReturned, FindSimilarMatchMode mode);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SimpleResponse<GroupResult>> groupWithRestResponseAsync(List<UUID> faceIds);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<GroupResult> groupAsync(List<UUID> faceIds);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SimpleResponse<List<IdentifyResult>>> identifyWithRestResponseAsync(List<UUID> faceIds);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<IdentifyResult>> identifyAsync(List<UUID> faceIds);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SimpleResponse<List<IdentifyResult>>> identifyWithRestResponseAsync(List<UUID> faceIds, String personGroupId, String largePersonGroupId, Integer maxNumOfCandidatesReturned, Double confidenceThreshold);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<IdentifyResult>> identifyAsync(List<UUID> faceIds, String personGroupId, String largePersonGroupId, Integer maxNumOfCandidatesReturned, Double confidenceThreshold);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SimpleResponse<VerifyResult>> verifyFaceToFaceWithRestResponseAsync(UUID faceId1, UUID faceId2);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<VerifyResult> verifyFaceToFaceAsync(UUID faceId1, UUID faceId2);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SimpleResponse<List<DetectedFace>>> detectWithUrlWithRestResponseAsync(String url);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<DetectedFace>> detectWithUrlAsync(String url);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SimpleResponse<List<DetectedFace>>> detectWithUrlWithRestResponseAsync(String url, Boolean returnFaceId, Boolean returnFaceLandmarks, List<FaceAttributeType> returnFaceAttributes, RecognitionModel recognitionModel, Boolean returnRecognitionModel, DetectionModel detectionModel);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<DetectedFace>> detectWithUrlAsync(String url, Boolean returnFaceId, Boolean returnFaceLandmarks, List<FaceAttributeType> returnFaceAttributes, RecognitionModel recognitionModel, Boolean returnRecognitionModel, DetectionModel detectionModel);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SimpleResponse<VerifyResult>> verifyFaceToPersonWithRestResponseAsync(UUID faceId, UUID personId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<VerifyResult> verifyFaceToPersonAsync(UUID faceId, UUID personId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SimpleResponse<VerifyResult>> verifyFaceToPersonWithRestResponseAsync(UUID faceId, UUID personId, String personGroupId, String largePersonGroupId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<VerifyResult> verifyFaceToPersonAsync(UUID faceId, UUID personId, String personGroupId, String largePersonGroupId);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<SimpleResponse<List<DetectedFace>>> detectWithStreamWithRestResponseAsync(long contentLength, Flux<ByteBuffer> image);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<DetectedFace>> detectWithStreamAsync(long contentLength, Flux<ByteBuffer> image);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<List<DetectedFace>> detectWithStreamAsync(long contentLength, Flux<ByteBuffer> image, Boolean returnFaceId, Boolean returnFaceLandmarks, List<FaceAttributeType> returnFaceAttributes, RecognitionModel recognitionModel, Boolean returnRecognitionModel, DetectionModel detectionModel);
}
