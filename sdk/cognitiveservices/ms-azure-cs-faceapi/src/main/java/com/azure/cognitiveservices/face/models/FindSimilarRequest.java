...
public final class FindSimilarRequest {
    ...
    /**
     * Get the faceId property: FaceId of the query face. User needs to call
    ...
    /**
     * Set the faceId property: FaceId of the query face. User needs to call
     * Face - Detect first to get a valid faceId. Note that this faceId is not
     * persisted and will expire 24 hours after the detection call.
     *
    ...
    /**
     * Get the faceListId property: An existing user-specified unique candidate
     * face list, created in Face List - Create a Face List. Face list contains
     * a set of persistedFaceIds which are persisted and will never expire.
    ...
    /**
     * Set the faceListId property: An existing user-specified unique candidate
     * face list, created in Face List - Create a Face List. Face list contains
     * a set of persistedFaceIds which are persisted and will never expire.
     * Parameter faceListId, largeFaceListId and faceIds should not be provided
     * at the same time.
    ...
    /**
     * Get the largeFaceListId property: An existing user-specified unique
     * candidate large face list, created in LargeFaceList - Create. Large face
     * list contains a set of persistedFaceIds which are persisted and will
     * never expire. Parameter faceListId, largeFaceListId and faceIds should
    ...
    /**
     * Set the largeFaceListId property: An existing user-specified unique
     * candidate large face list, created in LargeFaceList - Create. Large face
     * list contains a set of persistedFaceIds which are persisted and will
     * never expire. Parameter faceListId, largeFaceListId and faceIds should
     * not be provided at the same time.
    ...
    /**
     * Get the faceIds property: An array of candidate faceIds. All of them are
    ...
    /**
     * Set the faceIds property: An array of candidate faceIds. All of them are
     * created by Face - Detect and the faceIds will expire 24 hours after the
     * detection call. The number of faceIds is limited to 1000. Parameter
     * faceListId, largeFaceListId and faceIds should not be provided at the
     * same time.
    ...
    /**
     * Get the maxNumOfCandidatesReturned property: The number of top similar
    ...
    /**
     * Set the maxNumOfCandidatesReturned property: The number of top similar
     * faces returned. The valid range is [1, 1000].
     *
    ...
    /**
     * Get the mode property: Similar face searching mode. It can be
    ...
    /**
     * Set the mode property: Similar face searching mode. It can be
     * "matchPerson" or "matchFace". Possible values include: 'matchPerson',
     * 'matchFace'.
     *
