...
public final class FaceAsyncClient {
    ...
    public Mono<Response<List<SimilarFace>>> findSimilarWithResponse(
            UUID faceId,
            String faceListId,
        ...
        return this.serviceClient.findSimilarWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<SimilarFace>> findSimilar(
            UUID faceId,
            String faceListId,
            String largeFaceListId,
            List<UUID> faceIds,
            Integer maxNumOfCandidatesReturned,
            FindSimilarMatchMode mode) {
        return this.serviceClient.findSimilarAsync(
                faceId, faceListId, largeFaceListId, faceIds, maxNumOfCandidatesReturned, mode);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GroupResult>> groupWithResponse(List<UUID> faceIds) {
        return this.serviceClient.groupWithResponseAsync(faceIds);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GroupResult> group(List<UUID> faceIds) {
        return this.serviceClient.groupAsync(faceIds);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<IdentifyResult>>> identifyWithResponse(
            List<UUID> faceIds,
            String personGroupId,
            String largePersonGroupId,
            Integer maxNumOfCandidatesReturned,
            Float confidenceThreshold) {
        return this.serviceClient.identifyWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<IdentifyResult>> identify(
            List<UUID> faceIds,
            String personGroupId,
            String largePersonGroupId,
            Integer maxNumOfCandidatesReturned,
            Float confidenceThreshold) {
        return this.serviceClient.identifyAsync(
                faceIds, personGroupId, largePersonGroupId, maxNumOfCandidatesReturned, confidenceThreshold);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VerifyResult>> verifyFaceToFaceWithResponse(UUID faceId1, UUID faceId2) {
        return this.serviceClient.verifyFaceToFaceWithResponseAsync(faceId1, faceId2);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VerifyResult> verifyFaceToFace(UUID faceId1, UUID faceId2) {
        return this.serviceClient.verifyFaceToFaceAsync(faceId1, faceId2);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<DetectedFace>>> detectWithUrlWithResponse(
            String url,
        ...
        return this.serviceClient.detectWithUrlWithResponseAsync(
                url,
                returnFaceId,
                returnFaceLandmarks,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<DetectedFace>> detectWithUrl(
            String url,
            Boolean returnFaceId,
            Boolean returnFaceLandmarks,
            List<FaceAttributeType> returnFaceAttributes,
            ...
            Boolean returnRecognitionModel,
            DetectionModel detectionModel) {
        return this.serviceClient.detectWithUrlAsync(
                url,
                returnFaceId,
                returnFaceLandmarks,
                returnFaceAttributes,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VerifyResult>> verifyFaceToPersonWithResponse(
            UUID faceId, UUID personId, String personGroupId, String largePersonGroupId) {
        return this.serviceClient.verifyFaceToPersonWithResponseAsync(
                faceId, personId, personGroupId, largePersonGroupId);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VerifyResult> verifyFaceToPerson(
            UUID faceId, UUID personId, String personGroupId, String largePersonGroupId) {
        return this.serviceClient.verifyFaceToPersonAsync(faceId, personId, personGroupId, largePersonGroupId);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<DetectedFace>>> detectWithStreamWithResponse(
            ...
            Boolean returnRecognitionModel,
            DetectionModel detectionModel) {
        return this.serviceClient.detectWithStreamWithResponseAsync(
                image,
                contentLength,
                returnFaceId,
                returnFaceLandmarks,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<DetectedFace>> detectWithStream(
            Flux<ByteBuffer> image,
            long contentLength,
            Boolean returnFaceId,
            Boolean returnFaceLandmarks,
            ...
            Boolean returnRecognitionModel,
            DetectionModel detectionModel) {
        return this.serviceClient.detectWithStreamAsync(
                image,
                contentLength,
                returnFaceId,
                returnFaceLandmarks,
