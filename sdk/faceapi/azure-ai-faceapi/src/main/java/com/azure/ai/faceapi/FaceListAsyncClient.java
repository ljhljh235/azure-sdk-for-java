...
public final class FaceListAsyncClient {
    ...
    public Mono<Response<Void>> createWithResponse(
        ...
        return this.serviceClient.createWithResponseAsync(faceListId, name, userData, recognitionModel);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> create(String faceListId, String name, String userData, RecognitionModel recognitionModel) {
        return this.serviceClient.createAsync(faceListId, name, userData, recognitionModel);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<FaceList>> getWithResponse(String faceListId, Boolean returnRecognitionModel) {
        return this.serviceClient.getWithResponseAsync(faceListId, returnRecognitionModel);
    }
    ...
    public Mono<FaceList> get(String faceListId, Boolean returnRecognitionModel) {
        return this.serviceClient.getAsync(faceListId, returnRecognitionModel);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> updateWithResponse(String faceListId, String name, String userData) {
        return this.serviceClient.updateWithResponseAsync(faceListId, name, userData);
    }
    ...
    public Mono<Void> update(String faceListId, String name, String userData) {
        return this.serviceClient.updateAsync(faceListId, name, userData);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> deleteWithResponse(String faceListId) {
        return this.serviceClient.deleteWithResponseAsync(faceListId);
    }
    ...
    public Mono<Void> delete(String faceListId) {
        return this.serviceClient.deleteAsync(faceListId);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<FaceList>>> listWithResponse(Boolean returnRecognitionModel) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<FaceList>> list(Boolean returnRecognitionModel) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> deleteFaceWithResponse(String faceListId, UUID persistedFaceId) {
        return this.serviceClient.deleteFaceWithResponseAsync(faceListId, persistedFaceId);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> deleteFace(String faceListId, UUID persistedFaceId) {
        return this.serviceClient.deleteFaceAsync(faceListId, persistedFaceId);
    }
    ...
    public Mono<Response<PersistedFace>> addFaceFromUrlWithResponse(
        ...
        return this.serviceClient.addFaceFromUrlWithResponseAsync(
                faceListId, url, userData, targetFace, detectionModel);
    }
    ...
    public Mono<PersistedFace> addFaceFromUrl(
            String faceListId, String url, String userData, List<Integer> targetFace, DetectionModel detectionModel) {
        return this.serviceClient.addFaceFromUrlAsync(faceListId, url, userData, targetFace, detectionModel);
    }
