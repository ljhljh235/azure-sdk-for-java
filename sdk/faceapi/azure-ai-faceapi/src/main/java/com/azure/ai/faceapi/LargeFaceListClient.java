...
public final class LargeFaceListClient {
    ...
    public void create(String largeFaceListId, String name, String userData, RecognitionModel recognitionModel) {
        this.serviceClient.create(largeFaceListId, name, userData, recognitionModel);
    }
    ...
    public LargeFaceList get(String largeFaceListId, Boolean returnRecognitionModel) {
        return this.serviceClient.get(largeFaceListId, returnRecognitionModel);
    }
    ...
    public void update(String largeFaceListId, String name, String userData) {
        this.serviceClient.update(largeFaceListId, name, userData);
    }
    ...
    public void delete(String largeFaceListId) {
        this.serviceClient.delete(largeFaceListId);
    }
    ...
    public TrainingStatus getTrainingStatus(String largeFaceListId) {
        return this.serviceClient.getTrainingStatus(largeFaceListId);
    }
    ...
    public void train(String largeFaceListId) {
        this.serviceClient.train(largeFaceListId);
    }
    ...
    public void deleteFace(String largeFaceListId, UUID persistedFaceId) {
        this.serviceClient.deleteFace(largeFaceListId, persistedFaceId);
    }
    ...
    public PersistedFace getFace(String largeFaceListId, UUID persistedFaceId) {
        return this.serviceClient.getFace(largeFaceListId, persistedFaceId);
    }
    ...
    public void updateFace(String largeFaceListId, UUID persistedFaceId, String userData) {
        this.serviceClient.updateFace(largeFaceListId, persistedFaceId, userData);
    }
    ...
    public PersistedFace addFaceFromUrl(
        ...
        return this.serviceClient.addFaceFromUrl(largeFaceListId, url, userData, targetFace, detectionModel);
    }
    ...
    public List<PersistedFace> listFaces(String largeFaceListId, String start, Integer top) {
        return this.serviceClient.listFaces(largeFaceListId, start, top);
    }
