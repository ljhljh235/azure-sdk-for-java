...
public final class Exposure {
    ...
    /**
     * Set the exposureLevel property: An enum value indicating level of exposure.
     *
    ...
    /**
     * Set the value property: A number indicating level of exposure level ranging from 0 to 1. [0, 0.25) is under
     * exposure. [0.25, 0.75) is good exposure. [0.75, 1] is over exposure.
     *
     * @param value the value value to set.
     * @return the Exposure object itself.
     */
    public Exposure setValue(Float value) {
        this.value = value;
        return this;
    }
}
