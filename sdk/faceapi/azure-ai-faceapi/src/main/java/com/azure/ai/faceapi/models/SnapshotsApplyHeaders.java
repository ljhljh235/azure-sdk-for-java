...
/** The SnapshotsApplyHeaders model. */
@Fluent
public final class SnapshotsApplyHeaders {
    /*
     ...
     * @return the SnapshotsApplyHeaders object itself.
     */
    public SnapshotsApplyHeaders setOperationLocation(String operationLocation) {
