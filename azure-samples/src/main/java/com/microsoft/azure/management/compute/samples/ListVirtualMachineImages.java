...
//                }
//            }
            for (VirtualMachineImage image : azure.virtualMachineImages().listByRegion(Region.ASIA_EAST)) {
                                System.out.println("Image - " + image.publisherName() + "/"
                                        + image.offer() + "/"
                                        + image.sku() + "/" + image.version());
            }
        } catch (Exception e) {
